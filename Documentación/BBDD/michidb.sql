...
INSERT INTO GATO(nombre, edad, genero, descripcion, adoptado, Gusta, Odia)
VALUES 
('Sansón', '1', 'M', 'Sansón es un gatito de 1 año y medio muy amoroso y dormilón. Lo encontramos solo en un descampado, era el único de su familia que habia podido sobrevivir. Sus cosas favoritas en este mundo son comer, dormir y jugar un poco de vez en cuando. ¿Hemos dicho ya que le gusta dormir? Está completamente sano, desparasitado y esterilizado.', '0', 'Comer, dormir y que se acurruquen con él', 'Estar solo'),
('Sombra', '2', 'H', 'Sombra es una gatita de 2 años que encontramos en un contenedor junto a su hermanita Kuma. Las dos están a salvo con nosotros, pero ambas buscan un lugar donde poder jugar y dar todo el amor que tienen dentro. Es una gatita mega cariñosa, le encanta jugar con todos y saltar por todas partes. ¡Tiene mucha energía! Está completamente sana, desparasitada y esterilizada.', '0', 'Jugar, saltar, que le den premios', 'Que le corten las uñas'),
('Kuma', '2', 'H', 'Kuma es una gatita de 2 años, muy cariñosa y dormilona, la encontramos junto a su hermanita Sombra en un contenedor. Es un poco tímida al principio, pero cuando coge confianza, a Kuma le encanta acurrucarse y echarse la siesta. Está completamente sana, desparasitada y esterilizada.', '0', 'Esconderse y dormir', 'Ruidos fuertes'),
('Onyx', '2', 'M', 'Onyx es un gatito de 2 años y medio, muy travieso y juguetón al que le encanta estar con otros animales. Sus cosas favoritas son jugar a esconderse y dar sustos a sus demás compañeros. Está completamente sano, desparasitado y esterilizado.', '0', 'Jugar, estar con otros animales', 'Estar solo'),
('Tupu', '4', 'H', 'Tupu es una gatita de 4 añitos muy cariñosa y relajada. Es muy tranquila y reservada, pero le encanta estar con humanos y animales y dar mimos. Sus cosas favoritas son dormir al lado de su humano/a preferido/a y que le den mogollón de amor. Está completamente sana, desparasitada y esterilizada.', '0', 'Estar con humanos y animales, dar y recibir mimos', 'Bañarse'),
('Catra', '1', 'H', 'Catra es una gatita de 1 añito que nos trajeron nuestros compañeros del Michi Refugio. Es muy muy muy juguetona y le encanta salir corriendo por todas partes. Sus cosas favoritas en este mundo son jugar con cualquier cosa que se encuentra y correr, ¡no sabéis lo rápida que es! Está completamente sana, desparasitada y esterilizada.','0','Jugar con todo el mundo, dar muchos mimos, pedir comida', 'El agua');


ALTER TABLE Formulario ADD sobreti VARCHAR(200);
